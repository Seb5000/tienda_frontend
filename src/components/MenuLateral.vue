<template>
    <div class="menu">
        <div class="cabecera-menu">
            ...
            <div class="cabecera-menu_texto">
                CASA DE ARTE
            </div>
        </div>
        <ul class="navbar-nav">
            <li class="nav-item">
                <router-link class="nav-link" :to="{ name: 'Producto'}">
                    ...
                    <span class="link-text">Producto</span>
                </router-link>
            </li>
            <li class="nav-item">
                <router-link class="nav-link" :to="{ name: 'Compra'}">
                    ...
                    <span class="link-text">Compra</span>
                </router-link>
            </li>
            <li class="nav-item">
                <router-link class="nav-link" :to="{ name: 'Venta'}">
                    ...
                    <span class="link-text">Venta</span>
                </router-link>
            </li>
            <li class="nav-item">
                <router-link class="nav-link" :to="{ name: 'GrupoAccion'}">
                    ...
                    <span class="link-text">Agregar grupo accion</span>
                </router-link>
            </li>
        </ul>
